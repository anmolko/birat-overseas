<head>
    ...
    <meta name="description" content="@if(!empty(@$setting_data->meta_description)) {{ucwords(@$setting_data->meta_description)}} @else BIRAT OVERSEAS PVT. LTD - leading manpower company @endif"/>
    <meta name="keywords" content="@if(!empty(@$setting_data->meta_tags)) {{@$setting_data->meta_tags}} @else BIRAT OVERSEAS PVT. LTD - leading manpower company @endif">
    <meta name="csrf-token" content="{{ csrf_token() }}" />
    <link rel="canonical" href="https://biratoverseas.com/" />

    @if (\Request::is('/'))
        <title>@if(!empty(@$setting_data->website_name)) {{ucwords(@$setting_data->website_name)}} @else  BIRAT OVERSEAS PVT. LTD - leading manpower company @endif </title>
    @else
