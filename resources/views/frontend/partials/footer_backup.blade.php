        ...
        <div class="auto-container">
            <div class="row clearfix">
                <div class="column col-md-8 col-sm-12 col-xs-12">
                    <div class="copyright">Copyrights &copy; {{date("Y")}} {{$setting_data->website_name ?? 'BIRAT OVERSEAS PVT. LTD - leading manpower company'}} by <a href="https://www.canosoft.com.np/" target="_blank">Canosoft Techonology</a> All Rights Reserved.</div>
                </div>
