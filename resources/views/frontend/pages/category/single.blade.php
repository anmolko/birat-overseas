...
@endsection
@section('seo')
    <title>{{ucfirst(@$singleService->name)}} | @if(!empty(@$setting_data->website_name)) {{ucwords(@$setting_data->website_name)}} @else BIRAT OVERSEAS PVT. LTD - leading manpower company @endif </title>
