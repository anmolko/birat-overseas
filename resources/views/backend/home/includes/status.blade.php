            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="position-relative mb-3">
                        ...
                        <textarea class="form-control" maxlength="900" id="ckeditor-classic" name="grievance_description" placeholder="Enter grievance description" rows="6" required>{{@$settings->grievance_description}}</textarea>
