                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="position-relative mb-3">
                            ...
                            <input type="text" class="form-control" maxlength="25" id="direction-heading-input" name="action_heading" value="{{@$homesettings->action_heading}}"
                        ...
                        <div class="position-relative mb-3">
                            ...
                            <input type="text" class="form-control" maxlength="45" id="direction-heading-input" name="action_heading2" value="{{@$homesettings->action_heading2}}"
